...
const zh: Lang = {
  ...
  'command.repair-trade-identities': '修复交易身份',
  ...
  'notice.trade-identity-repair-complete':
    '交易身份修复完成：扫描 {scanned} 条，补全 {backfilled} 条，修复重复 {duplicates} 条。',
  'notice.error.repair-trade-identities': '修复交易身份失败：{error}',
  ...
  'widget.images.name': '图片',
  'widget.images.description': '支持上传的图片轮播',
  'widget.images.invalid-context':
    "图片组件需要在复盘笔记中使用(type: 'drc'、'weekly-review'、'monthly-review'、'quarterly-review' 或 'yearly-review')",
  'widget.images.alt-prefix': '复盘图片',
  'widget.images.stacked-alt': '复盘图片 {index}',
  'widget.images.open-fullscreen': '全屏查看图片 {index}',
  'widget.images.delete': '删除图片',
  'widget.images.empty': '暂无图片',
  'widget.images.placeholder': '粘贴图片 URL 或文件路径...',
  'widget.images.placeholder-add-more': '添加更多图片...',
  ...
  'settings.general.skip-weekends': '导航时跳过周末',
  'settings.general.skip-weekends-desc': '在日期导航时跳过周六和周日',
  'settings.general.skip-weekends-aria': '导航时跳过周末',
  'settings.general.skip-weekends-toggled': '跳过周末已{status}',
  ...
  'image.uploader.paste-title': '从剪贴板粘贴图片(Ctrl+V)',
  'image.uploader.pasting': '粘贴中...',
  'image.uploader.paste': '粘贴',
  'image.uploader.url-placeholder': '粘贴图片 URL 或文件路径...',
  'image.uploader.url-input-aria': '图片URL输入框',
  ...
  'image.viewer.description-default': '图片预览',
