...
export const TRADE_LOG_IMAGE_GALLERY_MAIN_GUIDE_ID =
  'tradelog.imageGallery.main';

export const TRADE_LOG_EMPTY_STATE_TARGET_ID = 'tradelog.empty-state';
export const TRADE_LOG_MODE_SELECTOR_TARGET_ID = 'tradelog.mode-selector';
export const TRADE_LOG_IMAGE_GALLERY_MODE_BUTTON_TARGET_ID =
...
export const TRADE_LOG_BATCH_TOOLBAR_TARGET_ID = 'tradelog.batch-toolbar';
export const TRADE_LOG_COLUMN_SETTINGS_BUTTON_TARGET_ID =
  'tradelog.column-settings-button';
export const TRADE_LOG_COLUMN_SETTINGS_MODAL_TARGET_ID =
  'tradelog.column-settings-modal';
export const TRADE_LOG_IMAGE_GALLERY_CONTROLS_TARGET_ID =
  'tradelog.image-gallery-controls';
export const TRADE_LOG_IMAGE_GALLERY_EMPTY_STATE_TARGET_ID =
...
export const TRADE_LOG_IMAGE_GALLERY_FULLSCREEN_ACTIONS_TARGET_ID =
  'tradelog.image-gallery-fullscreen-actions';
export const TRADE_LOG_IMAGE_GALLERY_TAG_BUTTON_TARGET_ID =
  'tradelog.image-gallery-tag-button';
...
export const TRADE_LOG_IMAGE_GALLERY_ANNOTATION_OPENED_ACTION_ID =
  'tradelog.image-gallery-annotation-opened';
